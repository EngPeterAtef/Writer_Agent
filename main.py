...
from langchain.utilities import WikipediaAPIWrapper, GoogleSearchAPIWrapper, SerpAPIWrapper
...
def main():
    ...
    st.set_page_config(page_title="Blog Writer Agent", page_icon=":message:", layout="wide")
    ...
    model = ChatOpenAI(temperature=0, openai_api_key=OPENAI_API_KEY, model="gpt-3.5-turbo-16k")

    prompt = """You are a helpful AI that helps the user to write a blog about {task}."""
